...
export interface PlgCardProps {
    ...
    onSubmit: (args: { galaxy?: string, planet: string, onSuccess?: () => void }) => Promise<void> | void;
}
            ...
            <form onSubmit={handleSubmit} className={styles.card}>
                ...
                <div className={styles.formGrid}>
                    <div className={styles.section}>
                        ...
                        <label htmlFor="galaxy" className={styles.label}>Galaxy Name</label>
                        <input
                            id="galaxy"
                            name="galaxy"
                            type="text"
                            ...
                            autoComplete="galaxy"
                        />
                        <p className={styles.optional}>Leave empty to create a standalone planet</p>
                    </div>
                    ...
                    <div className={styles.section}>
                        ...
                        <label htmlFor="planet" className={styles.label}>Planet Content</label>
                        <input
                            id="planet"
                            name="planet"
                            type="text"
